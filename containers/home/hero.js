...
export default function HomeHero() {
  return (
    <Section className="md:flex mt-4 bg-transparent z-10">
      <div className="w-full md:w-7/12 flex flex-col justify-center md:pr-40 z-10">
        <div className="text-4xl md:text-7xl text-test mb-8 md:mb-12 z-10">
          The next evolution of meditation
        </div>
        <p className="text-gray-light text-lg md:text-xl mb-4 md:mb-6 z-10">
          We’re building a community-powered meditation platform to support
          wellbeing in web3
        </p>
        <p className="text-gray-light text-lg md:text-xl mb-5 z-10">
        ...
        <div className="flex md:block justify-center md:justify-start z-10">
          <AppStoreLogo />
        </div>
      </div>
      <div className="flex-1 w-full p-20 md:pr-0 md:pt-0 xl:pr-32 md:w-8/12 z-10">
        <img
